 ...
 */
typedef struct astcenc_swizzle
{
...
typedef enum astcenc_flg
{
	...
	*/
	...
	/**
		...
		*/
	ASTCENC_FLG_USE_ALPHA_WEIGHT     = 1 << 2,
	...
	/**
		...
		*/
	ASTCENC_FLG_USE_PERCEPTUAL       = 1 << 3,
	...
	/**
		...
		*/
	ASTCENC_FLG_DECOMPRESS_ONLY      = 1 << 4,
	...
	/**
		...
		*/
	ASTCENC_FLG_SELF_DECOMPRESS_ONLY = 1 << 5,
 ...
 */
typedef struct astcenc_block_info
{
